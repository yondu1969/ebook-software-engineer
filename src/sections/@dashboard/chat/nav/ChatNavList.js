...
export default function ChatNavList({ conversations, openNav, onCloseNav, selected, sx, ...other }) {
  ...
  const handleSelectConversation = (conversationId) => {
    ...
    if (conversation.type === 'GROUP') {
      ...
      const otherParticipant = conversation.participants.find((participant) => participant.id !== CURRENT_USER_ID);
